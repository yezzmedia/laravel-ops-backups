...
final class TestOpsBackupsUser extends Authenticatable implements FilamentUser
{
    /**
    ...
    {
        return $this->panelAccess && $panel->getId() === 'ops-backups-test';
    }
